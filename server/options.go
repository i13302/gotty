...
type Options struct {
	...
	EnableStaticUrl     bool             `hcl:"static_url" flagName:"static-url" flagSName:"s" flagDescribe:"Add a random string to the URL" default:"false"`
	StaticUrlString     string           `hcl:"static_url_string" flagName:"url-str" flagSName:"u" flagDescribe:"Add a random string to the URL" default:""`
